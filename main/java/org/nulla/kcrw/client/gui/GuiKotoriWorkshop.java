...
public class GuiKotoriWorkshop extends KCGuiBase {
	...
	@Override
	public void initGui() {
		buttonList.add(btnChooseCraft = new GuiButtonImage(128, (int) (width * 0.32 - 16), (int) (height * 0.13 - 16),
				32, 32, KCResources.btn_craft, false));
		buttonList.add(btnChooseDecompose = new GuiButtonImage(129, (int) (width * 0.40 - 16),
				(int) (height * 0.13 - 16), 32, 32, KCResources.btn_decompose, false));
		buttonList.add(btnChooseReturn = new GuiButtonImage(130, (int) (width * 0.48 - 16), (int) (height * 0.13 - 16),
				32, 32, KCResources.btn_return, false));

		if (currentCraftItem != null) {
			buttonList.add(btnEnsureCraft = new GuiButtonImage(256, (int) (width * 0.42 + 10),
					(int) (height * 0.2 + 145), 16, 16, KCResources.btn_ensure, false));
		}
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		if (currentState.equals("CRAFT")) {
			...
			if (currentCraftItem != null) {
				...
				fontRendererObj.drawStringWithShadow(StatCollector.translateToLocal("kcrw.gui.currentCraftItem") + ":",
						zhong + 10, shang + 5, 0xAFAFAF);
				fontRendererObj.drawStringWithShadow(
						StatCollector.translateToLocal(currentCraftItem.getUnlocalizedName() + ".name"), zhong + 10,
						shang + 15, 0x7FFFBF);
				fontRendererObj.drawStringWithShadow(StatCollector.translateToLocal("kcrw.gui.currentCraftItemAmount")
						+ ": " + currentCraftItem.getRecipe().getProductAmount(), zhong + 10, shang + 35, 0xAFAFAF);
				fontRendererObj.drawStringWithShadow(
						StatCollector.translateToLocal("kcrw.gui.currentCraftItemInBag") + ": "
								+ KCUtils.getNumberOfItemInPlayer(crafter, currentCraftItem),
						zhong + 10, shang + 55, 0xAFAFAF);
				fontRendererObj.drawStringWithShadow(StatCollector.translateToLocal("kcrw.gui.needs") + ":", zhong + 10,
						shang + 75, 0xAFAFAF);
	...
	private void addCraftButton() {
		buttonList.add(btnCraft[0] = new GuiButtonImage(0, (int) (width * 0.15), (int) (height * 0.4), 32, 32,
				KCResources.item_peach_juice, true));
		buttonList.add(btnCraft[1] = new GuiButtonImage(1, (int) (width * 0.15 + 36), (int) (height * 0.4), 32, 32,
				KCResources.item_music_player, true));
		buttonList.add(btnCraft[2] = new GuiButtonImage(2, (int) (width * 0.15 + 72), (int) (height * 0.4), 32, 32,
				KCResources.item_aurora_iron_ingot, true));
	}
