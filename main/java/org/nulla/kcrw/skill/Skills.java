...
public class Skills {
	...
	public static final SkillAuroraBlast SkillAuroraBlast = new SkillAuroraBlast("aurora_blast", 1024, 32, 3 * 20);
	public static final SkillAuroraRepair SkillAuroraRepair = new SkillAuroraRepair("aurora_repair", 128, 1, 1 * 20);
	public static final SkillBaseballExplosive SkillExplosiveBaseball = new SkillBaseballExplosive("explosive_baseball", 128, 2, 2 * 20);
	public static final SkillBaseballRolling SkillBaseballRolling = new SkillBaseballRolling("rolling_baseball", 128, 2, 2 * 20);
