...
public class EntityVibrationWave extends EntityHasOwner {
    ...
    public void onUpdate() {
		...
		if (this.ticksExisted % 3 == 0) {
			...
			List list = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, AxisAlignedBB.fromBounds(
			...
			while (iterator.hasNext()) {
	            ...
	            if (entity.getEntityBoundingBox().minX > posX - r + 0.5
	            	&& entity.getEntityBoundingBox().maxX < posX + r - 0.5
	            	&& entity.getCollisionBoundingBox().minZ > posZ - r + 0.5
	            	&& entity.getEntityBoundingBox().maxZ < posZ + r - 0.5)
	            {
